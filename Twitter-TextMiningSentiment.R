...
setwd("C:/Users/HARSH/Google Drive/Sem1/MSI620-Big Data/R files")
...
twitter.sub <- read.csv("twittersubset.csv") #use read RDS for faster reads of large data sets instead of using a csv
...
gsub("!", "", c("hi!", "hi hi hi!!!")) #replace ! with space or nothing
